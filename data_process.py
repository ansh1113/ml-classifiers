...
def get_RICE_data() -> dict:
    ...
    mean = X_train_RICE.mean(axis=0)
    std = X_train_RICE.std(axis=0) + 1e-8  
    X_train_RICE = (X_train_RICE - mean) / std
    X_val_RICE = (X_val_RICE - mean) / std
    X_test_RICE = (X_test_RICE - mean) / std
